...
export const SUCCESSFUL_REVIEW_REGISTER =
  "Your review is registered successfully";
export const SUCCESSFUL_REVIEW_UPDATE = "Your review is updated successfully";
